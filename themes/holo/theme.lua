...
local theme                                     = {}
--To disable the regular X11
theme.border_width = 0
theme.default_dir                               = require("awful.util").get_themes_dir() .. "default"
theme.icon_dir                                  = os.getenv("HOME") .. "/.config/awesome/themes/holo/icons"
theme.wallpaper                                 = os.getenv("HOME") .. "/.config/awesome/themes/holo/wall7.jpg"
...
theme.bg_normal                                 = "#282a3622"
theme.bg_focus                                  = "#282a3633"
theme.bg_urgent                                 = "#282a3633"
theme.border_width                              = dpi(1)
--theme.border_normal                             = "#252525"
--theme.border_focus                              = "#0099CC"
theme.border_normal                             = "#6272a4"
theme.border_focus                              = "#4CB7DB"
theme.border_marked                             = "#4CB7DB"
theme.tasklist_bg_normal                        = "#282a3633"
theme.tasklist_fg_focus                         = "#4CB7DB"
theme.menu_height                               = dpi(20)
theme.menu_width                                = dpi(160)
theme.menu_icon_size                            = dpi(32)
theme.menu_fg_normal                            = "#f8f8f2"
theme.menu_fg_focus                             = "#ff79c6"
theme.menu_bg_normal                            = "#282a36bb"
theme.menu_bg_focus                             = "#44475acc"
theme.awesome_icon                              = theme.icon_dir .. "/distributor-logo-archlinux.png"
...
theme.titlebar_ontop_button_normal_inactive     = theme.icon_dir.."/titlebar/ontop_normal_inactive.svg"
--theme.titlebar_ontop_button_focus_inactive      = theme.default_dir.."/titlebar/ontop_focus_inactive.png"
theme.titlebar_ontop_button_focus_inactive      = theme.icon_dir.."/titlebar/ontop_focus_inactive.svg"
--theme.titlebar_ontop_button_normal_active       = theme.default_dir.."/titlebar/ontop_normal_active.png"
theme.titlebar_ontop_button_normal_active       = theme.icon_dir.."/titlebar/ontop_normal_active.svg"
--theme.titlebar_ontop_button_focus_active        = theme.default_dir.."/titlebar/ontop_focus_active.png"
theme.titlebar_ontop_button_focus_active        = theme.icon_dir.."/titlebar/ontop_focus_active.svg"
--theme.titlebar_sticky_button_normal_inactive    = theme.default_dir.."/titlebar/sticky_normal_inactive.png"
theme.titlebar_sticky_button_normal_inactive    = theme.icon_dir.."/titlebar/sticky_normal_inactive.svg"
--theme.titlebar_sticky_button_focus_inactive     = theme.default_dir.."/titlebar/sticky_focus_inactive.png"
theme.titlebar_sticky_button_focus_inactive     = theme.icon_dir.."/titlebar/sticky_focus_inactive.svg"
--theme.titlebar_sticky_button_normal_active      = theme.default_dir.."/titlebar/sticky_normal_active.png"
theme.titlebar_sticky_button_normal_active      = theme.icon_dir.."/titlebar/sticky_normal_active.svg"
--theme.titlebar_sticky_button_focus_active       = theme.default_dir.."/titlebar/sticky_focus_active.png"
theme.titlebar_sticky_button_focus_active       = theme.icon_dir.."/titlebar/sticky_focus_active.svg"
--theme.titlebar_floating_button_normal_inactive  = theme.default_dir.."/titlebar/floating_normal_inactive.png"
theme.titlebar_floating_button_normal_inactive  = theme.icon_dir.."/titlebar/floating_normal_inactive.svg"
--theme.titlebar_floating_button_focus_inactive   = theme.default_dir.."/titlebar/floating_focus_inactive.png"
theme.titlebar_floating_button_focus_inactive   = theme.icon_dir.."/titlebar/floating_focus_inactive.svg"
--theme.titlebar_floating_button_normal_active    = theme.default_dir.."/titlebar/floating_normal_active.png"
theme.titlebar_floating_button_normal_active    = theme.icon_dir.."/titlebar/floating_normal_active.svg"
--theme.titlebar_floating_button_focus_active     = theme.default_dir.."/titlebar/floating_focus_active.png"
theme.titlebar_floating_button_focus_active     = theme.icon_dir.."/titlebar/floating_focus_active.svg"
...
-- Clock
local mytextclock = wibox.widget.textclock(markup("#f8f8f2", space3 .. "%H:%M   " .. markup.font("Roboto 4", " ")))
...
-- Calendar
local mytextcalendar = wibox.widget.textclock(markup.fontfg(theme.font, "#f8f8f2", space3 .. "%d %b " .. markup.font("Roboto 5", " ")))
...
local memory = lain.widget.mem({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#ff5555", mem_now.used .. "M "))
    end
})
...
local temp = lain.widget.temp({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#ffb86c", coretemp_now .. "°C "))
    end
})
...
local barcolor  = gears.color({
    ...
    from  = { dpi(32), 0 },
    to    = { dpi(32), dpi(32) },
    stops = { {0, theme.bg_focus}, {0.25, "#44475a33"}, {1, theme.bg_focus} }
})
...
function theme.at_screen_connect(s)
    ...
    awful.tag({ "֪", "<", "ϊ", "Ի", "Ԥ"}, s, awful.layout.layouts)
    ...
    s.mytaglist = awful.widget.taglist(s, awful.widget.taglist.filter.all, awful.util.taglist_buttons, { bg_focus = barcolor, fg_focus = "#50fa7b", fg_empty = "#6272a4" })
    ...
    s.mywibox:setup {
	    ...
	    memory.widget,
	    bar,
	    fs_widget({ mounts = { '/','/home' ,'/run/media/byron/Code', '/run/media/byron/Data', '/run/media/byron/Projects', '/run/media/byron/Vm' } }),
            bar,
            --musicwidget,
            --bar,
            prev_icon,
